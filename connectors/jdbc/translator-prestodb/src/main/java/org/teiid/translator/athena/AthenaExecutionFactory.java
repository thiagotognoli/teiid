...
public class AthenaExecutionFactory extends PrestoDBExecutionFactory {
    ...
    public AthenaExecutionFactory() {
        //https://issues.redhat.com/browse/ENTESB-13704
        //may not be needed if the presto driver is used
        setUseBindVariables(false);
    }

    @Override
    public boolean supportsCorrelatedSubqueries() {
        //https://issues.redhat.com/browse/ENTESB-13703
        return false;
    }
